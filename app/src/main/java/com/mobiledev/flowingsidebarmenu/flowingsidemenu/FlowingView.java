...
public class FlowingView extends View {
    ...
    private DrawerFragment mMenuFragment ;
    ...
    public void downing() {
        ...
        ValueAnimator valueAnimator = ValueAnimator.ofInt(w + 200, w - 80);
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                currentPointX = (int) animation.getAnimatedValue();
                float fraction = animation.getAnimatedFraction();
                autoUppingX = (int) (w - 80 * fraction);
                invalidate();
            }
        });
    ...
    public void setMenuFragment(DrawerFragment mMenuFragment ){
